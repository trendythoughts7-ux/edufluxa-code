(function ($) {
    ...
    $('body').on('click', '.js-view-comment', function (e) {
        ...
        var html = '<div class="p-20">' +
            ...
            '</div>'+
            '<p class="font-weight-500 text-gray-500 mt-20">' + comment + '</p>' +
            '</div>';
    ...
    $('body').on('click', '.report-comment', function (e) {
        ...
        const html = '<div id="reportModal" class="p-20">\n' +
            '<div class="section-title">'+
            '    <h3 class="section-title__heading font-20 text-dark-blue mb-24">' + reportLang + '</h3>\n' +
            '</div>'+
            '\n' +
