(function ($) {
    ...
    $('body').on('click', '.js-reply-comment', function (e) {
        ...
        var html = '<div class="p-16">\n' +
            ...
            '        <form id="commentForm" action="/panel/events/comments/' + comment_id + '/reply" method="post" class="mt-20">\n' +
    ...
    $('body').on('click', '.js-edit-comment', function (e) {
        ...
        var html = '<div class="p-16">\n' +
            ...
            '        <form action="/panel/events/comments/' + comment_id + '/update" method="post" class="mt-20">\n' +
    ...
    $('body').on('click', '.js-report-comment', function (e) {
        ...
        const html = '<div id="reportModal" class="p-16">\n' +
            ...
            '\n' +
            '    <form action="/panel/events/comments/' + comment_id + '/report" method="post">\n' +
            '        <div class="form-group">\n' +
