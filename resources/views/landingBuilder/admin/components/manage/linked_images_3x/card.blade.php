<div class="js-links-info-item-card ">
    <x-landingBuilder-input
        ...
        name="contents[specific_banners][{{ !empty($itemKey) ? $itemKey : 'record' }}][title]"
    ...
    <x-landingBuilder-file
        ...
        hint="{{ trans('update.preferred_size') }} 440x280px"
        icon="export"
        accept="image/*"
        className=""
    />
    ...
    <x-landingBuilder-switch
        ...
        name="contents[specific_banners][{{ !empty($itemKey) ? $itemKey : 'record' }}][enable]"
