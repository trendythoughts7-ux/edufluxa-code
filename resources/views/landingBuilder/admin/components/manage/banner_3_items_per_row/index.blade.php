                    ...
                    @foreach($contents['specific_banners'] as $sKey => $itemData)
                        @if($sKey != 'record')
                            <x-landingBuilder-accordion
                                ...
                                show=""
                            >
                                @include('landingBuilder.admin.components.manage.banner_3_items_per_row.banner',['itemKey' => $sKey, 'bannerData' => $itemData])
                            </x-landingBuilder-accordion>
                        @endif
                    @endforeach
                @endif
...
<div class="js-banner-item-main-card d-none">
    <x-landingBuilder-accordion
        ...
        show="true"
    >
        @include('landingBuilder.admin.components.manage.banner_3_items_per_row.banner')
    </x-landingBuilder-accordion>
</div>
