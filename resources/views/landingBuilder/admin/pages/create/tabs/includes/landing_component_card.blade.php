<li data-id="{{ $landingComponent->id }}">
    <div class="d-flex align-items-center justify-content-between mt-16 bg-white p-16 rounded-12">
        <div class="d-flex align-items-center">
            ...
            <div class="ml-8">
                <h5 class="font-14">{{ trans("update.{$landingComponent->landingBuilderComponent->name}_component_title") }}</h5>
                <p class="font-12 text-gray-500 mt-2">{{ trans("update.{$landingComponent->landingBuilderComponent->name}_component_hint") }}</p>
            </div>
        </div>
            ...
            <div class="actions-dropdown position-relative d-flex justify-content-end align-items-center">
                ...
                <div class="actions-dropdown__dropdown-menu dropdown-menu-width-220">
                    <ul class="my-8">
                        ...
                        @if($landingComponent->enable)
                            <li class="actions-dropdown__dropdown-menu-item">
                                <a href="{{ getLandingBuilderUrl("/{$landingItem->id}/components/{$landingComponent->id}/disable") }}"
                                   class="delete-action"
                        ...
                        @else
                            <li class="actions-dropdown__dropdown-menu-item">
                                <a href="{{ getLandingBuilderUrl("/{$landingItem->id}/components/{$landingComponent->id}/enable") }}"
                                   class="delete-action"
                        ...
                        <li class="actions-dropdown__dropdown-menu-item">
                            <a href="{{ getLandingBuilderUrl("/{$landingItem->id}/components/{$landingComponent->id}/delete") }}" class="delete-action text-danger ">{{ trans('public.delete') }}</a>
                        </li>
                    </ul>
                </div>
            </div>

            <a href="{{ getLandingBuilderUrl("/{$landingItem->id}/components/{$landingComponent->id}/edit") }}" target="_blank" class="d-flex-center cursor-pointer" data-tippy-content="{{ trans('public.edit') }}">
