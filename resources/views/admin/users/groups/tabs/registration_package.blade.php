    ...
    <div class="row">
        <div class="col-12 col-md-6">
            <form action="{{ getAdminPanelUrl() }}/users/groups/{{ $group->id }}/groupRegistrationPackage" method="Post">
                ...
                @php
                    $packageItems = ['instructors_count','students_count','courses_capacity','courses_count','meeting_count','product_count', 'events_count', 'meeting_packages_count', 'jobs_count'];
                @endphp
