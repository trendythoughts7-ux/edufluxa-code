                                ...
                                <div class="col-12 col-md-6">
                                    <form action="{{ getAdminPanelUrl('/certificates/settings') }}" method="post">
                                        ...
                                        <div class="form-group custom-switches-stacked">
                                            ...
                                            <div class="text-gray-500 text-small">{{ trans('update.certificate_setting_active_hint') }}</div>
                                        </div>
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p class="text-gray-500 font-12 mt-1">{{ trans('update.certificate_api_user_id_hint') }}</p>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p class="text-gray-500 font-12 mt-1">{{ trans('update.certificate_api_key_hint') }}</p>
                                            </div>
