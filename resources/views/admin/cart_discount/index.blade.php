                        ...
                        <div class="col-12 col-md-8 col-lg-6">
                            <form action="{{ getAdminPanelUrl("/cart_discount/store") }}" method="Post">
                                ...
                                <div class="form-group custom-switches-stacked">
                                    ...
                                    <div class="text-gray-500 text-small mt-1">{{ trans('update.cart_discount_show_only_on_empty_cart_hint') }}</div>
                                </div>
                                ...
                                <div class="form-group custom-switches-stacked">
                                    ...
                                    <div class="text-gray-500 text-small mt-1">{{ trans('update.cart_discount_enable_hint') }}</div>
                                </div>
