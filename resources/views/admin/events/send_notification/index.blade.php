    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="card">
                <div class="card-body">
                    <p class="">
                        <span class="font-weight-bold">{{ trans('update.event') }}</span>:
                        {{ $event->title }}
                    </p>

                    <form method="post" action="{{ getAdminPanelUrl('/events/'. $event->id .'/send-notification') }}" class="form-horizontal form-bordered mt-4">
                        {{ csrf_field() }}
