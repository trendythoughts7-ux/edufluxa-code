                ...
                <div class="col-12 col-md-12">
                    ...
                    <div class="card-header justify-content-between">
                            ...
                            @can('admin_categories_create')
                                   <a href="{{ getAdminPanelUrl() }}/categories/create" target="_blank" class="btn btn-primary">
                                       <x-iconsax-lin-add class="icons text-white" width="18px" height="18px"/>
                                       <span class="ml-4 text-small font-small font-12">{{ trans('admin/main.new') }} {{ trans('admin/main.category') }}</span>
                                   </a>
                               @endcan
