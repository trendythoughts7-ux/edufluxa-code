        ...
        <div class="col-12 col-md-6">
            <form action="{{ getAdminPanelUrl() }}/settings/main" method="post">
                ...
                <div class="form-group custom-switches-stacked">
                    <label class="custom-switch pl-0 d-flex align-items-center">
                        ...
                        <label class="custom-switch-description mb-0 cursor-pointer"
                            for="referralStatusSwitch">{{ trans('admin/main.active') }}</label>
                    </label>
                ...
                <div class="form-group custom-switches-stacked">
                    <label class="custom-switch pl-0 d-flex align-items-center">
                        ...
                        <input type="checkbox" name="value[users_affiliate_status]" id="userReferralStatusSwitch"
                            value="1" {{ (!empty($itemValue) and !empty($itemValue['users_affiliate_status']) and $itemValue['users_affiliate_status']) ? 'checked="checked"' : '' }}
                            class="custom-switch-input" />
                        <span class="custom-switch-indicator"></span>
                        <label class="custom-switch-description mb-0 cursor-pointer"
                            for="userReferralStatusSwitch">{{ trans('admin/main.active_users_affiliate_when_registration') }}
                        </label>
                    </label>
                    <div class="text-gray-500 text-small mt-1">{{ trans('admin/main.active_referral_new_users_hint') }}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="text-gray-500 text-small mt-1">{{ trans('admin/main.affiliate_user_commission_hint') }}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="value[store_affiliate_user_commission]"
                            ...
                            class="form-control text-center @error('store_affiliate_user_commission') is-invalid @enderror"
                            maxlength="3" min="0" max="100" />
                    ...
                    <div class="text-gray-500 text-small mt-1">
                        {{ trans('admin/main.store_affiliate_user_commission_hint') }}</div>
                </div>

                <div class="form-group">
                    <label>{{ trans('admin/main.course_affiliate_commission') }}</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <i class="fas fa-percentage"></i>
                        ...
                        <input type="number" name="value[course_affiliate_commission]"
                            value="{{ (!empty($itemValue) and !empty($itemValue['course_affiliate_commission'])) ? $itemValue['course_affiliate_commission'] : old('course_affiliate_commission') }}"
                            class="form-control text-center @error('course_affiliate_commission') is-invalid @enderror"
                            maxlength="3" min="0" max="100" />

                        @error('course_affiliate_commission')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        @enderror
                    ...
                    <div class="text-gray-500 text-small mt-1">
                        {{ trans('admin/main.course_affiliate_commission_hint') }}</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="text-gray-500 text-small mt-1">{{ trans('admin/main.affiliate_user_amount_hint') }}
                    </div>
                </div>
