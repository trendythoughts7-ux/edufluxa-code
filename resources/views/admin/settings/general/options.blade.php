        ...
        <div class="col-12 col-md-6">
            <form action="{{ getAdminPanelUrl() }}/settings/general_options" method="post">
                ...
                <div class="mb-5">
                    ...
                    @php
                        $directPublicationOptions = ['direct_publication_of_courses', 'direct_publication_of_bundles', 'direct_publication_of_upcoming_courses', 'direct_publication_of_events', 'direct_publication_of_comments', 'direct_publication_of_reviews', 'direct_publication_of_blog', 'direct_publication_of_jobs'];
                    @endphp
