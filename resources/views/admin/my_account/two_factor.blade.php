...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('update.two_factor_authentication') }}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="{{ getAdminPanelUrl() }}">{{ trans('admin/main.dashboard') }}</a></div>
                <div class="breadcrumb-item ">{{ trans('update.two_factor_authentication') }}</div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div id="tfa-app" class="mt-16" data-enabled="{{ $twoFactorEnabled ? '1' : '0' }}">
                                ...
                                <div id="tfa-state-enroll" style="display:none;" class="mt-16">
                                    ...
                                    <div class="form-group mt-16" style="max-width:280px;">
                                        <label class="input-label">{{ trans('update.enter_6_digit_code') }}</label>
                                        <input type="text" id="tfa-confirm-code" class="form-control" maxlength="6" inputmode="numeric" autocomplete="one-time-code">
                                    </div>
                                    ...
                                    <button type="button" id="tfa-cancel-enroll" class="btn btn-secondary mt-16">
                                        {{ trans('public.cancel') }}
                                    </button>
                                </div>
                                ...
                                <div id="tfa-state-enabled" style="{{ $twoFactorEnabled ? '' : 'display:none;' }}" class="mt-16">
                                    ...
                                    <div class="form-group mt-16" style="max-width:320px;">
                                        <label class="input-label">{{ trans('public.current_password') }}</label>
                                        <input type="password" id="tfa-disable-password" class="form-control" autocomplete="current-password">
                                    </div>
                                    ...
                                    <div class="mt-16 pt-16" style="border-top:1px solid #eee;">
                                        ...
                                        <div class="form-group" style="max-width:320px;">
                                            <label class="input-label">{{ trans('public.current_password') }}</label>
                                            <input type="password" id="tfa-regenerate-password" class="form-control" autocomplete="current-password">
                                        </div>
                                        <div id="tfa-regenerate-error" class="text-danger font-12 mt-8" style="display:none;"></div>
                                        <button type="button" id="tfa-regenerate-btn" class="btn btn-secondary mt-16">
...
@push('scripts_bottom')
    <script>
        (function () {
            ...
            var baseUrl = '{{ getAdminPanelUrl() }}/my-account/2fa';
            ...
            if (startEnrollBtn) {
                startEnrollBtn.addEventListener('click', function () {
                    ...
                    postJson(baseUrl + '/enroll').then(function (result) {
            ...
            if (confirmBtn) {
                confirmBtn.addEventListener('click', function () {
                    ...
                    postJson(baseUrl + '/confirm', { one_time_password: code }).then(function (result) {
            ...
            if (disableBtn) {
                disableBtn.addEventListener('click', function () {
                    ...
                    postJson(baseUrl + '/disable', { password: password }).then(function (result) {
            ...
            if (regenerateBtn) {
                regenerateBtn.addEventListener('click', function () {
                    ...
                    postJson(baseUrl + '/regenerate', { password: password }).then(function (result) {
