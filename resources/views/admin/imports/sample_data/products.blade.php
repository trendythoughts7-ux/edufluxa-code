<div class="d-flex align-items-center bg-primary-20 p-8 rounded-12">
    ...
    <div class="ml-8">
        <h4 class="font-14 m-0 text-primary">{{ trans('update.products_import_instructions') }}</h4>
        <div class="font-12 text-primary opacity-70">{{ trans('update.follow_these_steps_to_prepare_and_import_your_products_data_correctly') }}</div>
    </div>
</div>
...
<div class="table-responsive mt-20">
    <table class="table custom-table font-14">
        ...
        <tr>
            ...
            <td>physical</td>
            <td>This Product helps you create...</td>
            <td>This Product helps you create additiona...</td>
            <td>This Product helps you c...</td>
            <td>16</td>
            <td>12</td>
...
<div class="row mt-5">
    ...
    <div class="col-md-4">
        ...
        <ul class="list-style-disc text-gray-500 mb-0" id="optionalFields">
            ...
            <li class="py-1">Inventory</li>
            <li class="py-1">Creator ID</li>
    ...
    <div class="col-md-4">
        ...
        <ul class="list-style-disc text-gray-500 mb-0">
            ...
            <li class="py-1"> {{ trans('update.import_from_csv_products_price_hint') }}</li>
            <li class="py-1"> {{ trans('update.import_from_csv_products_type_hint') }}</li>
        </ul>
    </div>
...
<div class="col-lg-12 mt-16">
    <div class="d-flex align-items-center justify-content-end">
        <a href="{{ getAdminPanelUrl("/imports/download-sample?type=products") }}" class="btn btn-primary btn-lg gap-8">
