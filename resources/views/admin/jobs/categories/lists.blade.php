                        ...
                        <div class="card-header justify-content-between">
                            ...
                            <div class="d-flex align-items-center gap-12">
                                ...
                                @can('admin_store_categories_create')
                                    <a href="{{ getAdminPanelUrl("/jobs/categories/create") }}" target="_blank" class="btn btn-primary">
                            ...
                            <div class="table-responsive">
                                <table class="table custom-table font-14">
                                    <tr>
                                        ...
                                        <th>{{ trans('update.jobs') }}</th>
                                        <th>{{ trans('admin/main.has_sub_category') }}</th>
                                            ...
                                            <td>
                                                @if($category->sub_categories_count > 0)
                                                    <div class="d-flex-center flex-column">
                                                        <span>{{ trans('admin/main.yes') }}</span>
                                                        <span class="font-12 text-gray-500 mt-4">{{ trans('admin/main.count') }}: {{ $category->sub_categories_count }}</span>
                                                    </div>
                                                @else
                                                    <span>{{ trans('admin/main.no') }}</span>
                                                @endif
                                            </td>
                                                ...
                                                <div class="btn-group dropdown table-actions position-relative">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        @can('admin_store_categories_edit')
                                                            <a href="{{ getAdminPanelUrl() }}/jobs/categories/{{ $category->id }}/edit"
                                                        ...
                                                        @can('admin_store_categories_delete')
                                                            @include('admin.includes.delete_button',[
                                                                'url' => getAdminPanelUrl().'/jobs/categories/'.$category->id.'/delete',
