<section class="mt-30">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <button type="button"
                ...
                data-path="{{ getAdminPanelUrl("/jobs/{$job->id}/faqs/get-form") }}"
    ...
    <div class="row mt-10">
        <div class="col-12">
            ...
            @if(!empty($job->faqs) and $job->faqs->isNotEmpty())
                                    ...
                                    <div class="btn-group dropdown table-actions position-relative">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <button type="button" class="js-job-contents-action-btn dropdown-item d-flex align-items-center mb-3 py-3 px-0 gap-4"
                                                    data-path="{{ getAdminPanelUrl("/jobs/{$job->id}/faqs/{$faq->id}/edit") }}"
                                            ...
                                            @include('admin.includes.delete_button',[
                                                'url' => getAdminPanelUrl("/jobs/{$job->id}/faqs/{$faq->id}/delete"),
            ...
            @else
                <div class="d-flex-center flex-column px-32 py-120 text-center">
                    ...
                    <p class="mt-4 font-12 text-gray-500">{!! trans('update.job_faq_no_result_hint') !!}</p>
                </div>
            @endif
        </div>
    </div>
