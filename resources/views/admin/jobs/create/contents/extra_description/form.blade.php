<form id="jobFaqsForm" action="{{ getAdminPanelUrl("/jobs/{$job->id}/extra-description/") }}{{ !empty($extraDescription) ? ($extraDescription->id.'/update') : 'store' }}" method="post">
    ...
    @else
        ...
        @if(!empty(getGeneralSettings('content_translate')))
            <div class="form-group">
                ...
                <select name="locale" class="form-control {{ !empty($extraDescription) ? 'js-job-content-locale' : '' }}" data-title="{{ trans('update.edit_faq') }}">
