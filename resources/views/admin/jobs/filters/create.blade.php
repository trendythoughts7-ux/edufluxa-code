    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="{{ getAdminPanelUrl() }}/jobs/filters">{{ trans('admin/main.filters') }}</a>
                </div>
        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ getAdminPanelUrl() }}/jobs/filters/{{ !empty($filter) ? $filter->id.'/update' : 'store' }}" method="Post">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title"
                                           ...
                                           value="{{ (!empty($filter) and !empty($filter->translate($locale))) ? $filter->translate($locale)->title : old('title') }}"
                                                ...
                                                <li class="form-group list-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="sub_filters[{{ $filterOption->id }}][title]"
                                                               ...
                                                               value="{{ (!empty($filterOption->translate($locale))) ? $filterOption->translate($locale)->title : '' }}"
                                                               placeholder="{{ trans('admin/main.choose_title') }}"/>
