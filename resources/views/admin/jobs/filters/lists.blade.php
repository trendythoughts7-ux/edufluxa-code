                        ...
                        <div class="card-header justify-content-between">
                            ...
                            <div class="d-flex align-items-center gap-12">
                                ...
                                @can('admin_store_filters_create')
                                    <a href="{{ getAdminPanelUrl("/jobs/filters/create") }}" target="_blank" class="btn btn-primary">
                            ...
                            <div class="table-responsive">
                                <table class="table custom-table font-14">
                                    <tr>
                                        ...
                                        <th class="text-center">{{ trans('update.options') }}</th>
                                    ...
                                    @foreach($filters as $filter)
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $filter->options_count }}</td>
                                            <td width="80px">
                                                <div class="btn-group dropdown table-actions position-relative">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        @can('admin_store_filters_edit')
                                                            <a href="{{ getAdminPanelUrl() }}/jobs/filters/{{ $filter->id }}/edit"
                                                        ...
                                                        @can('admin_store_filters_delete')
                                                            @include('admin.includes.delete_button',[
                                                                'url' => getAdminPanelUrl().'/jobs/filters/'.$filter->id.'/delete',
