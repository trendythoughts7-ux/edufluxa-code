                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="form-group mt-30 d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" name="chat_room" class="custom-control-input" id="chatRoomSwitch" {{ !empty($webinar) && $webinar->chat_room ? 'checked' : ''  }}>
                                                    <label class="custom-control-label" for="chatRoomSwitch"></label>
                                                </div>
                                            </div>
                                            @endif
