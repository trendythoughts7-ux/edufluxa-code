    ...
    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
        <div class="card-statistic">
            ...
            <div class="card-statistic__wrap">
                ...
                <h5 class="font-24 mt-12 line-height-1 text-black">{{ $totalAttendanceCount }}</h5>
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
        <div class="card-statistic">
            ...
            <div class="card-statistic__wrap">
                ...
                <h5 class="font-24 mt-12 line-height-1 text-black">{{ $totalPresentRecords }}</h5>
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
        <div class="card-statistic">
            ...
            <div class="card-statistic__wrap">
                ...
                <h5 class="font-24 mt-12 line-height-1 text-black">{{ $totalLateRecords }}</h5>
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
        <div class="card-statistic">
            ...
            <div class="card-statistic__wrap">
                ...
                <h5 class="font-24 mt-12 line-height-1 text-black">{{ $totalAbsentRecords }}</h5>
            </div>
        </div>
    </div>
</div>
