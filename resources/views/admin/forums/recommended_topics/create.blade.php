                                    ...
                                    <form action="{{ getAdminPanelUrl() }}/recommended-topics/{{ !empty($recommended) ? $recommended->id.'/update' : 'store'  }}" method="post">
                                        ...
                                        @if(!empty(getGeneralSettings('content_translate')))
                                            <div class="form-group">
                                                ...
                                                <select name="locale" class="custom-select {{ !empty($recommended) ? 'js-edit-content-locale' : '' }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="subtitle" id="subtitle" value="{{ (!empty($recommended)) ? $recommended->subtitle : old('subtitle') }}" class="form-control @error('subtitle') is-invalid @enderror"/>
                                            @error('subtitle')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <button type="submit" class="btn btn-primary text-right">{{ trans('admin/main.submit') }}</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
