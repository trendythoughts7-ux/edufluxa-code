                    ...
                    <div class="card-header justify-content-between">
                            ...
                            <div class="d-flex align-items-center gap-12">
                                ...
                                @can('admin_featured_topics_create')
                                   <a href="{{ getAdminPanelUrl("/featured-topics/create") }}" target="_blank" class="btn btn-primary">
                                ...
                                <table class="table custom-table font-14">
                                    ...
                                    @foreach($featuredTopics as $feature)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center font-12">{{ dateTimeFormat($feature->created_at, 'j M Y | H:i') }}</td>
    ...
    <div class="btn-group dropdown table-actions position-relative">
        ...
        <div class="dropdown-menu dropdown-menu-right">
            @can('admin_featured_topics_edit')
                <a href="{{ getAdminPanelUrl() }}/featured-topics/{{ $feature->id }}/edit"
            ...
            @can('admin_featured_topics_delete')
                @include('admin.includes.delete_button',[
                    'url' => getAdminPanelUrl().'/featured-topics/'.$feature->id.'/delete',
