        ...
        <div class="actions-dropdown position-relative d-flex justify-content-end align-items-center">
            ...
            <div class="actions-dropdown__dropdown-menu dropdown-menu-width-220 dropdown-menu-top-32">
                <ul class="my-8">
                        ...
                        @if(!empty($session->date))
                            @if($session->status == "active")
                                <li class="actions-dropdown__dropdown-menu-item">
                                    <button type="button"
                                            data-path="/panel/meetings/purchased-packages/{{ $meetingPackageSold->id }}/sessions/{{ $session->id }}/join-modal"
                            ...
                            <li class="actions-dropdown__dropdown-menu-item">
                                <button type="button"
                                        data-path="/panel/meetings/purchased-packages/{{ $meetingPackageSold->id }}/sessions/{{ $session->id }}/finish-modal"
                    ...
                    <li class="actions-dropdown__dropdown-menu-item">
                        <button type="button" data-path="/panel/meetings/purchased-packages/{{ $meetingPackageSold->id }}/get-instructor-detail" data-title="{{ trans('update.instructor_information') }}" class="js-meeting-sold-package-student-detail">{{ trans('update.instructor_detail') }}</button>
                    </li>
