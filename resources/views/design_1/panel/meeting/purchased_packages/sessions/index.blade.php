...
@section('content')
    ...
    {{-- Top Stats --}}
    @include('design_1.panel.meeting.purchased_packages.sessions.package_details')
    ...
    @if(!empty($sessions) and !$sessions->isEmpty())
        <div class="bg-white pt-16 rounded-24 mt-20">
            ...
            {{-- List Table --}}
            <div id="tableListContainer" class="table-responsive-lg" data-view-data-path="/panel/meetings/purchased-packages/{{ $meetingPackageSold->id }}/sessions">
                <table class="table panel-table">
                    ...
                    @foreach($sessions as $sessionRow)
                        @include('design_1.panel.meeting.purchased_packages.sessions.table_items', ['session' => $sessionRow])
                    @endforeach
                    </tbody>
                </table>
