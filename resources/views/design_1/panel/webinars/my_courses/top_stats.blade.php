<div class="row">
    <div class="col-6 col-lg-3">
        <div class="bg-white p-16 rounded-24">
            ...
            <h5 class="font-24 mt-12 line-height-1">{{ $totalCoursesCount }}</h5>
        </div>
    </div>
    ...
    <div class="col-6 col-lg-3 mt-16 mt-lg-0">
        <div class="bg-white p-16 rounded-24">
            <div class="d-flex align-items-start justify-content-between">
                <span class="text-gray-500 mt-8">{{ trans('update.total_live_classes_sales') }}</span>
            ...
            <h5 class="font-24 mt-12 line-height-1">{{ handlePrice($totalLiveCoursesSalesAmount) }}</h5>
        </div>
    </div>
    ...
    <div class="col-6 col-lg-3 mt-16 mt-lg-0">
        <div class="bg-white p-16 rounded-24">
            <div class="d-flex align-items-start justify-content-between">
                <span class="text-gray-500 mt-8">{{ trans('update.total_course_sales') }}</span>
            ...
            <h5 class="font-24 mt-12 line-height-1">{{ handlePrice($totalCoursesSalesAmount) }}</h5>
        </div>
    </div>
</div>
