        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-8">
                ...
                <div class="d-flex-center flex-column text-center">
                    ...
                    <p class="mt-8 font-16 text-gray-500">{{ trans('update.job_application_request_details_hint') }}</p>
                </div>
                ...
                <div class="card-with-mask position-relative">
                    ...
                    <div class="position-relative z-index-3 bg-white p-16 rounded-32 mt-24 ">
                        {{-- Job Details --}}
                        @include("design_1.panel.jobs.my_requests.details.includes.job_details")
                        ...
                        @if(!empty($jobRequest->userResume))
                            ...
                            <div class="d-flex gap-16 align-items-center justify-content-between p-16 rounded-12 border-gray-200 mt-16">
                                ...
                                <a href="/panel/jobs/my-requests/{{ $jobRequest->id }}/details/download-resume" class="d-flex-center" data-tippy-content="{{ trans('home.download') }}">
                        ...
                        {{-- Certificates --}}
                        @include("design_1.panel.jobs.my_requests.details.includes.certificates")

                        {{-- Learning History --}}
                        @include("design_1.panel.jobs.my_requests.details.includes.learning_history")
                        ...
                        {{-- Attachments --}}
                        @include("design_1.panel.jobs.my_requests.details.includes.attachments")

                        <div class="d-flex align-items-center justify-content-between gap-16 mt-16 pt-16 border-top-gray-100">
                            <a href="/panel/jobs/my-requests" class="btn btn-lg bg-gray-300 text-gray-500">{{ trans('update.back') }}</a>
