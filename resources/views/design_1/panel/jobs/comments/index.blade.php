...
@section('content')
    ...
    {{-- Top Stats --}}
    @include('design_1.panel.jobs.comments.top_stats')
    ...
    @if(!empty($comments) and !$comments->isEmpty())
        <div class="bg-white pt-16 rounded-24 mt-20">
            ...
            {{-- Filters --}}
            @include('design_1.panel.jobs.comments.filters')

            {{-- List Table --}}
            <div id="tableListContainer" class="table-responsive-lg" data-view-data-path="/panel/jobs/comments">
                <table class="table panel-table">
                    ...
                    @foreach($comments as $commentRow)
                        @include('design_1.panel.jobs.comments.table_items', ['comment' => $commentRow])
                    @endforeach
                    </tbody>
                </table>
...
@push('scripts_bottom')
    ...
    <script src="/assets/design_1/js/panel/jobs_comments.min.js"></script>
@endpush
