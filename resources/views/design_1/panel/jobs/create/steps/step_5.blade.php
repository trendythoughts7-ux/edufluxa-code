...
<div class="bg-white rounded-16 p-16 mt-32">
    ...
    <div class="d-flex align-items-center justify-content-between p-12 rounded-16 border-gray-300 border-dashed">
        <div class="d-flex align-items-center">
            ...
            <div class="ml-8">
                ...
                <p class="mt-4 font-12 text-gray-500">{{ trans('update.add_FAQ_and_display_them_on_the_job_page') }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-6 mt-20">
            @include('design_1.panel.jobs.create.includes.accordions.faq')
        </div>

        <div class="col-lg-6 mt-36">
            @if(!empty($job->faqs) and count($job->faqs))
                <div class="p-16 rounded-16 border-gray-200">
                    ...
                    <ul class="draggable-content-lists faq-draggable-lists" data-path="" data-drag-class="faq-draggable-lists">
                        @foreach($job->faqs as $faqInfo)
                            @include('design_1.panel.jobs.create.includes.accordions.faq',['faq' => $faqInfo])
                        @endforeach
                    </ul>
    ...
    @php
        $learningMaterials = $job->extraDescriptions->where('type', 'learning_materials');
        $requirements = $job->extraDescriptions->where('type', 'requirements');
    @endphp
    ...
    <div class="d-flex align-items-center justify-content-between mt-32 p-12 rounded-16 border-gray-300 border-dashed">
        <div class="d-flex align-items-center">
            ...
            <div class="ml-8">
                <h5 class="font-14 font-weight-bold">{{ trans('update.job_learning_materials') }}</h5>
                <p class="mt-4 font-12 text-gray-500">{{ trans('update.job_learning_materials_hint') }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-6 mt-20">
            @include('design_1.panel.jobs.create.includes.accordions.extra_description', [
        ...
        <div class="col-lg-6 mt-36">
            @if(!empty($learningMaterials) and count($learningMaterials))
                <div class="p-16 rounded-16 border-gray-200">
                    <h3 class="font-14 font-weight-bold">{{ trans('update.job_learning_materials') }}</h3>
            ...
            @else
                <div class="d-flex-center flex-column px-32 py-120 text-center">
                    ...
                    <h3 class="font-16 font-weight-bold mt-12">{{ trans('update.job_learning_materials_no_result') }}</h3>
                    <p class="mt-4 font-12 text-gray-500">{!! trans('update.job_learning_materials_no_result_hint') !!}</p>
                </div>
            @endif
    ...
    <div class="d-flex align-items-center justify-content-between mt-32 p-12 rounded-16 border-gray-300 border-dashed">
        <div class="d-flex align-items-center">
            ...
            <div class="ml-8">
                <h5 class="font-14 font-weight-bold">{{ trans('update.job_requirements') }}</h5>
                <p class="mt-4 font-12 text-gray-500">{{ trans('update.job_requirements_hint') }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mt-36">
            @if(!empty($requirements) and count($requirements))
                <div class="p-16 rounded-16 border-gray-200">
                    <h3 class="font-14 font-weight-bold">{{ trans('update.job_requirements') }}</h3>
            ...
            @else
                <div class="d-flex-center flex-column px-32 py-120 text-center">
                    ...
                    <h3 class="font-16 font-weight-bold mt-12">{{ trans('update.job_requirements_no_result') }}</h3>
                    <p class="mt-4 font-12 text-gray-500">{!! trans('update.job_requirements_no_result_hint') !!}</p>
                </div>
            @endif
    ...
    <div class="d-flex align-items-center justify-content-between mt-32 p-12 rounded-16 border-gray-300 border-dashed">
        <div class="d-flex align-items-center">
            ...
            <div class="ml-8">
                ...
                <p class="mt-4 font-12 text-gray-500">{{ trans('update.display_company_logos_on_the_job_page') }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="border-dashed border-gray-300 rounded-16 p-28 mt-16">
        @include("design_1.panel.jobs.create.includes.accordions.company_logos")
    </div>
