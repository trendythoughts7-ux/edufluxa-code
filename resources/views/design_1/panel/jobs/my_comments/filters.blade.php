<form action="/panel/jobs/my-comments" method="get" class="px-16">
    <div class="row mt-24">
        ...
        <div class="col-6 col-md-3">
            <div class="form-group ">
                ...
                <select name="job_id" class="form-control searchable-select bg-white" data-placeholder="{{ trans('update.search_jobs') }}"
                        data-api-path="/panel/jobs/search"
