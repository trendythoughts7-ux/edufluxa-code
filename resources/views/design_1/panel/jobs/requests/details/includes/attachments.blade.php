        ...
        @foreach($jobRequest->attachments as $attachment)
            <div class="col-12 col-md-6 mt-16">
                <div class="d-flex gap-16 align-items-center justify-content-between p-16 rounded-12 border-gray-200">
                    ...
                    <a href="/panel/jobs/{{ $jobRequest->job_id }}/requests/{{ $jobRequest->id }}/details/download-item?type=attachment&item={{ $attachment->id }}" class="d-flex-center" data-tippy-content="{{ trans('home.download') }}">
