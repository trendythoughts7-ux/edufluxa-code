<div class="row">
    <div class="col-6 col-lg-3">
        <div class="bg-white p-16 rounded-24">
            ...
            <h5 class="font-24 mt-12 line-height-1">{{ $totalResultsCount }}</h5>
        </div>
    </div>
    ...
    <div class="col-6 col-lg-3">
        <div class="bg-white p-16 rounded-24">
            <div class="d-flex align-items-start justify-content-between">
                <span class="text-gray-500 mt-8">{{ trans('update.passed_results') }}</span>
            ...
            <h5 class="font-24 mt-12 line-height-1">{{ $totalPassedResults }}</h5>
        </div>
    </div>
    ...
    <div class="col-6 col-lg-3 mt-16 mt-md-0">
        <div class="bg-white p-16 rounded-24">
            <div class="d-flex align-items-start justify-content-between">
                <span class="text-gray-500 mt-8">{{ trans('update.failed_results') }}</span>
            ...
            <h5 class="font-24 mt-12 line-height-1">{{ $totalFailedResults }}</h5>
        </div>
    </div>
    ...
    <div class="col-6 col-lg-3 mt-16 mt-md-0">
        <div class="bg-white p-16 rounded-24">
            <div class="d-flex align-items-start justify-content-between">
                <span class="text-gray-500 mt-8">{{ trans('update.pending_review_results') }}</span>
            ...
            <h5 class="font-24 mt-12 line-height-1">{{ $totalPendingReviewResults }}</h5>
        </div>
    </div>
</div>
