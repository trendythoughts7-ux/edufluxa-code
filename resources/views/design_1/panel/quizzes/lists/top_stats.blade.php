 <div class="row">
        <div class="col-12 col-lg-4">
            <div class="bg-white p-16 rounded-24">
                <div class="d-flex align-items-start justify-content-between">
                    <span class="text-gray-500 mt-8">{{ trans('quiz.quizzes') }}</span>
                ...
                <h5 class="font-24 mt-12 line-height-1">{{ $quizzesCount }}</h5>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-4 mt-16 mt-lg-0">
            <div class="bg-white p-16 rounded-24">
                <div class="d-flex align-items-start justify-content-between">
                    <span class="text-gray-500 mt-8">{{ trans('public.questions') }}</span>
                ...
                <h5 class="font-24 mt-12 line-height-1">{{ $questionsCount }}</h5>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-4 mt-16 mt-lg-0">
            <div class="bg-white p-16 rounded-24">
                ...
                <h5 class="font-24 mt-12 line-height-1">{{ $userCount }}</h5>
            </div>
        </div>
