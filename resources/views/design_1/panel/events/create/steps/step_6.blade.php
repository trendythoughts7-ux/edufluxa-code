...
<div class="bg-white rounded-16 p-16 mt-32">
    ...
    <div class="form-group mt-24">
        ...
        <textarea name="message_for_reviewer" rows="10" class="form-control">{{ (!empty($event) and $event->message_for_reviewer) ? $event->message_for_reviewer : old('message_for_reviewer') }}</textarea>
    </div>
