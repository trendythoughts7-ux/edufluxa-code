<tr>
    <td class="text-left">
        <a class="text-dark" href="{{ $comment->event->getUrl() }}" target="_blank">{{ $comment->event->title }}</a>
    </td>
            ...
            <div class="actions-dropdown__dropdown-menu dropdown-menu-width-220 dropdown-menu-top-32">
                <ul class="my-8">
                    ...
                    <li class="actions-dropdown__dropdown-menu-item">
                        <a href="" class="js-edit-comment" data-comment-id="{{ $comment->id }}">{{ trans('public.edit') }}</a>
                    </li>

                    <li class="actions-dropdown__dropdown-menu-item">
                        <a href="/panel/events/comments/{{ $comment->id }}/delete" class="delete-action text-danger">{{ trans('public.delete') }}</a>
                    </li>
