<form action="/panel/events/my-comments" method="get" class="px-16">
    <div class="row mt-24">
        ...
        <div class="col-6 col-md-3">
            <div class="form-group ">
                ...
                <select name="event_id" class="form-control searchable-select bg-white" data-placeholder="{{ trans('update.search_events') }}"
                        data-api-path="/panel/events/search"
