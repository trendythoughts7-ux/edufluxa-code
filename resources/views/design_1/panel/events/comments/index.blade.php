...
@section('content')
    ...
    {{-- Top Stats --}}
    @include('design_1.panel.events.comments.top_stats')
    ...
    @if(!empty($comments) and !$comments->isEmpty())
        <div class="bg-white pt-16 rounded-24 mt-20">
            ...
            {{-- Filters --}}
            @include('design_1.panel.events.comments.filters')

            {{-- List Table --}}
            <div id="tableListContainer" class="table-responsive-lg" data-view-data-path="/panel/events/comments">
                <table class="table panel-table">
                    ...
                    @foreach($comments as $commentRow)
                        @include('design_1.panel.events.comments.table_items', ['comment' => $commentRow])
                    @endforeach
                    </tbody>
                </table>
...
@push('scripts_bottom')
    ...
    <script src="/assets/design_1/js/panel/events_comments.min.js"></script>
@endpush
