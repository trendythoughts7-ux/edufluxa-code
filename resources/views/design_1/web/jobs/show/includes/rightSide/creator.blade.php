    ...
    <div class="position-relative bg-white rounded-24 p-16 z-index-2">
        ...
        <div class="d-flex align-items-center">
            <div class="position-relative size-64 rounded-circle">
                ...
                @if($userRow->verified)
                    <div class="job-right-side__teacher-verified-badge d-flex-center rounded-circle size-16 p-2 bg-primary" data-tippy-content="{{ trans('public.verified') }}">
        ...
        @if($userRow->offline)
            <div class="mt-16 p-12 rounded-12 border-gray-200 bg-gray-100">
                <div class="d-flex align-items-center">
                    ...
                    <span class="ml-4 font-12 font-weight-bold text-gray-500">{{ trans('update.the_employer_is_currently_unavailable') }}</span>
                </div>
