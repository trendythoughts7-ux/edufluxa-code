                ...
                @if($userCurrency == $currencyItem->currency)
                    <div class="d-flex align-items-center gap-8">
                        <div class="size-32 d-flex-center bg-white-10 rounded-8">
                            <span class="font-12 text-white opacity-75">{{ currencySign($currencyItem->currency) }}</span>
                        </div>
                        <span class="js-lang-title text-white opacity-75 d-none d-md-flex">{{ $currencyItem->currency }}</span>
