<div class="theme-header-mobile__drawer mobile-auth-user-drawer">
    ...
    <div class="theme-header-mobile__drawer-body py-16">
                    ...
                    <div class="d-flex-center size-48 bg-white rounded-circle">
                        <div class="position-relative d-flex-center size-40 rounded-circle">
                            ...
                            @if($authUser->verified)
                                <div class="theme-header-mobile__user-verify-badge d-flex-center rounded-circle size-16 p-2 bg-primary" data-tippy-content="{{ trans('public.verified') }}">
        ...
        <ul class="my-8">
            <li class="">
                <a href="{{ ($authUser->isAdmin()) ? getAdminPanelUrl("/") : '/panel' }}" class="d-flex align-items-center w-100 px-16 py-8 text-gray-500">
            ...
            <li class="">
                <a href="/panel/notifications" class="d-flex align-items-center w-100 px-16 py-8 text-gray-500">
                    ...
                    @if(!empty($unReadNotifications) and count($unReadNotifications))
                        <span class="d-inline-flex-center text-white rounded-circle ml-auto bg-danger p-2">{{ count($unReadNotifications) }}</span>
                    @endif
                </a>
            </li>
            ...
            @if(!$authUser->isUser())
                <li class="">
                    <a href="/panel/courses" class="d-flex align-items-center w-100 px-16 py-8 text-gray-500">
                ...
                <li class="">
                    <a href="/panel/financial/sales" class="d-flex align-items-center w-100 px-16 py-8 text-gray-500">
            ...
            @else
                <li class="">
                    <a href="/panel/courses/purchases" class="d-flex align-items-center w-100 px-16 py-8 text-gray-500">
                        <x-iconsax-lin-video-play class="icons" width="24px" height="24px"/>
            ...
            <li class="">
                <a href="/panel/support/new" class="d-flex align-items-center w-100 px-16 py-8 text-gray-500">
            ...
            <li class="">
                <a href="{{ $authUser->getProfileUrl() }}" class="d-flex align-items-center w-100 px-16 py-8 text-gray-500">
            ...
            <li class="">
                <a href="/panel/setting" class="d-flex align-items-center w-100 px-16 py-8 text-gray-500">
            ...
            <li class="">
                <a href="/logout" class="d-flex align-items-center w-100 px-16 py-8 text-gray-500">
