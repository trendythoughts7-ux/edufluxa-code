<div class="theme-header-2__dropdown position-relative">
    <div class="d-flex align-items-center">
        ...
        <div class="ml-8 text-gray-500">{{ $authUser->full_name }}</div>
        <x-iconsax-lin-arrow-down class="icons text-gray-500 ml-12" width="16px" height="16px"/>
    </div>
    ...
    <div class="header-2-dropdown-menu auth-user-info-dropdown-menu py-12">
                    ...
                    <div class="d-flex-center size-48 bg-white rounded-circle">
                        <div class="position-relative d-flex-center size-40 rounded-circle">
                            ...
                            @if($authUser->verified)
                                <div class="theme-header-2__dropdown-user-verify-badge d-flex-center rounded-circle size-16 p-2 bg-primary" data-tippy-content="{{ trans('public.verified') }}">
        ...
        <ul class="my-8">
            <li class="header-2-dropdown-menu__item">
