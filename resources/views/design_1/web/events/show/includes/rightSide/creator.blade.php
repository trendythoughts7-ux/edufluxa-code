<div class="event-right-side-section position-relative mt-28">
    ...
    <div class="position-relative bg-white rounded-24 p-16 z-index-2">
        ...
        @if($isInstructorOnlineSystem)
            <div class="event-right-side__teacher-invited instructor-online-badge instructor-online-badge--compact" id="instructorOnlineBadgeCourse" style="display:inline-flex;">
        ...
        <div class="d-flex align-items-center">
            <div class="position-relative size-64 rounded-circle">
                ...
                @if($userRow->verified)
                    <div class="event-right-side__teacher-verified-badge d-flex-center rounded-circle size-16 p-2 bg-primary" data-tippy-content="{{ trans('public.verified') }}">
        ...
        <div class="position-relative d-flex align-items-center flex-wrap gap-12 mt-32 pt-36 pr-16 pl-20 pb-20 rounded-12 border-gray-200">
            ...
            <div class="event-right-side__teacher-rate-card p-8 rounded-24 bg-gray-100">
