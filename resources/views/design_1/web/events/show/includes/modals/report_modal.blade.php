<div class="d-flex-center flex-column text-center mt-16">
    <div class="event-report-icon d-flex-center size-64 rounded-24">
    ...
    <p class="mt-4 font-12 text-gray-500">{{ trans('update.report_event_modal_hint') }}</p>
</div>

<form action="/events/{{ $event->id }}/report" method="post" class="js-event-report-form mt-24">
