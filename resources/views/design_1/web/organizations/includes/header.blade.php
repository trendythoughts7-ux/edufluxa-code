    ...
    <div class="position-relative d-flex align-items-start bg-white rounded-32 z-index-2">
        <div class="d-flex flex-column p-32">
            ...
            <div class="d-flex align-items-center mt-16 text-gray-500">
                ...
                <span class="">{{ trans('home.organizations') }}</span>
            </div>

            <h1 class="font-24 font-weight-bold mt-12">{{ trans('home.organizations') }}</h1>
            <div class="font-12 text-gray-500 mt-8">{{ trans('update.explore_all_organizations_in_one_place_and_find_your_desired_organization') }}</div>
        </div>
