...
class DashboardDataService
{
    ...
    public function getStudentHelloBoxData($user, $userBoughtWebinarsIds): array
    {
    ...
    public function getStudentCoursesOverviewData($user, $userBoughtWebinarsIds): array
    {
    ...
    public function getStudentMyAssignmentsData($user, $userBoughtWebinarsIds)
    {
    ...
    public function getStudentLearningActivityData($user, $userBoughtWebinarsIds): array
    {
    ...
    public function getStudentSupportMessagesData($user, $userBoughtWebinarsIds): array
    {
    ...
    public function getStudentMyQuizzesData($user, $userBoughtWebinarsIds): array
    {
     ...
     * | Instructors Data
     * ***********/
    public function getInstructorHelloBoxData($user, $meetingIds, $userWebinars): array
    {
    ...
    public function getInstructorCoursesOverviewData($user, $userWebinars): array
    {
    ...
    public function getInstructorSalesOverviewData($user, $userWebinarsIds): array
    {
        $totalCourseSales = 0;
        $totalProductSales = 0;
        $totalMeetingSales = 0;
    ...
    public function getInstructorSupportMessagesData($user, $userWebinarsIds): array
    {
        $query = Support::query()->select('*', DB::raw("case
            when status = 'open' then 'a'
            when status = 'replied' then 'a'
    ...
    public function getInstructorVisitorsStatisticsData($user, $userWebinarsIds)
    {
    ...
    public function getInstructorUpcomingLiveSessionsData($user, $userWebinarsIds)
    {
        $time = time();
    ...
    public function getInstructorOpenMeetingsData($user, $userWebinarsIds)
    {
    ...
    public function getOrganizationTopInstructorsData($user)
    {
    ...
    public function getOrganizationTopStudentsData($user)
    {
        $query = User::query()->where('organ_id', $user->id)
