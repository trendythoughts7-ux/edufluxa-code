...
class MultiCurrency
{
    ...
    {
        // Performance: cache the currency list (rarely changes) instead of querying on every request.
        // Invalidated in FinancialCurrencySettings trait via cache()->forget('multi_currencies').
        return cache()->remember('multi_currencies', 24 * 60 * 60, function () {
