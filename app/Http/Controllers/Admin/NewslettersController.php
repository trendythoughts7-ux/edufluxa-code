...
class NewslettersController extends Controller
{
    ...
    public function sendNewsletter(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'bcc_email' => 'required_if:send_method,send_to_bcc' . ($request->get('send_method') == 'send_to_bcc' ? '|email|regex:/^[^\r\n]+$/' : ''),
    ...
    public function exportExcel()
    {
        ...
        ProcessGenericExport::dispatch(NewslettersExport::class, $newsletters, $exportRecord->id, 'newsletters');
