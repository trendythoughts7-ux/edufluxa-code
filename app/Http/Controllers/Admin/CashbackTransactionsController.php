...
class CashbackTransactionsController extends Controller
{
    ...
    public function exportExcel(Request $request)
    {
        ...
        $exportRecord = Export::create([
            'user_id' => auth()->id(),
            'type' => 'cashback_transactions',
            'status' => Export::STATUS_PENDING,
        ]);

        ProcessGenericExport::dispatch(CashbackTransactionsExport::class, $transactions, $exportRecord->id, 'cashback_transactions');
    ...
    public function historyExportExcel(Request $request)
    {
        ...
        $exportRecord = Export::create([
            'user_id' => auth()->id(),
            'type' => 'cashback_history',
            'status' => Export::STATUS_PENDING,
        ]);

        ProcessGenericExport::dispatch(CashbackHistoryExport::class, $transactions, $exportRecord->id, 'cashback_history');
