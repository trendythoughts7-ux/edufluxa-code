...
class AbandonedUsersCartController extends Controller
{
    ...
    {
        $exportData = $this->buildExportData($request);
        ...
        ProcessGenericExport::dispatch(AbandonedUsersCartExport::class, $exportData, $exportRecord->id, 'abandoned_carts');
