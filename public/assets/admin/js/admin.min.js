...
/***/ "./resources/js/design_1/app_includes/icon_picker.js":
/*!***********************************************************!*\
  !*** ./resources/js/design_1/app_includes/icon_picker.js ***!
  \***********************************************************/
/***/ (() => {
...
(function ($) {
  ...
  window.handleChooseIconSelect2 = function ($iconsSelect2) {
    if ($iconsSelect2.length) {
      var _$iconsSelect2$attr;
      var dropdownParent = (_$iconsSelect2$attr = $iconsSelect2.attr('data-dropdown-parent')) !== null && _$iconsSelect2$attr !== void 0 ? _$iconsSelect2$attr : 'body';
...
/***/ "./resources/js/design_1/app_includes/main.js":
/*!****************************************************!*\
  !*** ./resources/js/design_1/app_includes/main.js ***!
  \****************************************************/
/***/ (() => {
...
(function ($) {
  ...
  * */
  window.handleSelect2 = function ($element) {
    var _$element$attr, _$element$attr2;
    var placeholder = $element.attr('data-placeholder');
    var dropdownParent = (_$element$attr = $element.attr('data-dropdown-parent')) !== null && _$element$attr !== void 0 ? _$element$attr : 'body';
    var maximumSelectionLength = (_$element$attr2 = $element.attr('data-maximumSelectionLength')) !== null && _$element$attr2 !== void 0 ? _$element$attr2 : 0; // default 0 means not limitation
  ...
  window.handleSearchableSelect = function ($element) {
    var _$element$attr3, _$element$attr4;
    var column = $element.attr('data-item-column-name');
    var placeholder = $element.attr('data-placeholder');
    var apiPath = $element.attr('data-api-path');
    var option = $element.attr('data-option');
    var webinarId = $element.attr('data-webinar-id');
    var itemId = $element.attr('data-item-id');
    var dropdownParent = (_$element$attr3 = $element.attr('data-dropdown-parent')) !== null && _$element$attr3 !== void 0 ? _$element$attr3 : 'body';
    var maximumSelectionLength = (_$element$attr4 = $element.attr('data-maximumSelectionLength')) !== null && _$element$attr4 !== void 0 ? _$element$attr4 : 0; // default 0 means not limitation
        ...
        processResults: function processResults(data) {
          return {
            results: $.map(data, function (item) {
              var _item$column, _item$id;
              return {
                text: (_item$column = item[column]) !== null && _item$column !== void 0 ? _item$column : '',
  ...
  * */
  window.loadingSwl = function () {
    var loadingHtml = '<div class="d-flex align-items-center justify-content-center py-56 "><img src="/assets/design_1/img/loading.svg" width="80" height="80"></div>';
    Swal.fire({
      html: loadingHtml,
  ...
  $('body').on('click', '.delete-action', function (e) {
    var _$$attr, _$$attr2, _$$attr3, _$$attr4;
    e.preventDefault();
    e.stopPropagation();
    var href = $(this).attr('href');
    var modalTitle = (_$$attr = $(this).attr('data-modal-title')) !== null && _$$attr !== void 0 ? _$$attr : deleteRequestLang;
    var title = (_$$attr2 = $(this).attr('data-title')) !== null && _$$attr2 !== void 0 ? _$$attr2 : deleteAlertTitle;
    var msg = (_$$attr3 = $(this).attr('data-msg')) !== null && _$$attr3 !== void 0 ? _$$attr3 : deleteAlertHint;
    var confirm = (_$$attr4 = $(this).attr('data-confirm')) !== null && _$$attr4 !== void 0 ? _$$attr4 : deleteAlertConfirm;
    var bodyHtml = "<div class=\"d-flex-center flex-column text-center p-32\">\n                <div class=\"d-flex-center size-72 rounded-16 bg-gray\">\n                    <div class=\"d-flex-center size-64 rounded-16 bg-danger\">".concat(bulDangerIcon, "</div>\n                </div>\n\n                <h4 class=\"font-14 text-dark mt-8\">").concat(title, "</h4>\n                <p class=\"text-gray-500 mt-8\">").concat(msg, "</p>\n            </div>");
    var $footerHtml = "<div class=\"d-flex align-items-center gap-24 justify-content-end\">\n            <button type=\"button\" class=\"close-swl btn btn-transparent\">".concat(deleteAlertCancel, "</button>\n            <button type=\"button\" id=\"swlDelete\" data-href=\"").concat(href, "\" class=\"btn btn-danger\">").concat(confirm, "</button>\n        </div>");
    var html = makeModalHtml(modalTitle, closeIcon, bodyHtml, $footerHtml);
    Swal.fire({
      html: html,
      showCancelButton: false,
      showConfirmButton: false,
  ...
  $('body').on('click', '#swlDelete', function (e) {
    ...
    $.get(href, function (result) {
      if (result && result.code === 200) {
        var _result$title, _result$msg;
        var title = (_result$title = result.title) !== null && _result$title !== void 0 ? _result$title : deleteAlertSuccess;
        var msg = (_result$msg = result.msg) !== null && _result$msg !== void 0 ? _result$msg : deleteAlertSuccessHint;
        Swal.fire({
          title: title,
          html: "<div class=\"text-center mt-8 mb-12\">".concat(msg, "</div>"),
          showConfirmButton: false,
          icon: 'success'
        });
        setTimeout(function () {
        ...
        var _result$title2, _result$msg2;
        var _title = (_result$title2 = result.title) !== null && _result$title2 !== void 0 ? _result$title2 : deleteAlertFail;
        var _msg = (_result$msg2 = result.msg) !== null && _result$msg2 !== void 0 ? _result$msg2 : deleteAlertFailHint;
        Swal.fire({
          title: _title,
          html: "<div class=\"text-center mt-8 mb-12\">".concat(_msg, "</div>"),
          icon: 'error'
        });
      ...
      Swal.fire({
        ...
        html: "<div class=\"text-center mt-8 mb-12\">".concat(deleteAlertFailHint, "</div>"),
        icon: 'error'
      });
      $this.removeClass('loadingbar primary').prop('disabled', false);
    });
  ...
  * */
  ...
  window.customToast = function (html) {
    var hideAfter = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 5000;
    var randomId = 'id-' + randomString(6);
    $('body').append("<div class=\"custom-toast-alert\" id=\"".concat(randomId, "\">").concat(html, "</div>"));
    var $toastEl = $('#' + randomId);
    setTimeout(function () {
  ...
  * */
  ...
  function handleAccordionArrow($accordion, show, target) {
    var $arrow = $accordion.find('.collapse-arrow-icon[href="' + target + '"]');
  ...
  window.handleAccordionCollapse = function () {
    $("[data-toggle='collapse']").each(function () {
      ...
      $this.off('click').on('click', function () {
        ...
        var $parent = $("".concat(parent));
        var collapseJustOne = $this.attr("data-collapse") === "one";
        if ($parent.length && collapseJustOne) {
          $parent.find('.accordion__collapse.show').each(function () {
            var $openTarget = $(this);
            var $openTargetAccordion = $openTarget.closest('.accordion');
  ...
  window.makeModalHtml = function (title, cIcon, html) {
    var footer = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
    var subtitle = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
    return "<div class=\"js-custom-modal rounded-top-20 soft-shadow-5 pt-24\">\n            <div class=\"d-flex align-items-center justify-content-between px-16\">\n                <div class=\"\">\n                    <h3 class=\"font-16 text-black\">".concat(title, "</h3>\n\n                    ").concat(subtitle ? '<p class="mt-8 font-14 text-gray-500">' + subtitle + '</p>' : '', "\n                </div>\n\n                <button class=\"modal-close-btn close-swl\">").concat(cIcon, "</button>\n            </div>\n\n            <div class=\"position-relative py-8 custom-swl-modal-body has-footer px-16\">\n                ").concat(html, "\n            </div>\n\n            ").concat(footer ? "<div class=\"custom-modal-footer bg-gray-100 p-16 w-100 rounded-bottom-20\">".concat(footer, "</div>") : '', "\n        </div>");
  };
  ...
  window.handleTranslations = function (translations, defaultLocale, column) {
    var justTranslateByLocale = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    var text = null;
  ...
  $('body').on('click', '.input-step .plus', function (e) {
    e.preventDefault();
    var $this = $(this);
    var $input = $this.closest('.input-step').find('input');
    var val = $input.val() ? Number($input.val()) : 0;
    $input.val(val + 1);
  });
  ...
  $('body').on('click', '[data-tab-toggle]', function (e) {
    e.preventDefault();
    var $this = $(this);
    var $parent = $this.closest('.custom-tabs');
    ...
    var customEvent = $.Event('shown.cs.tab', {
      bubbles: true
    });
  ...
  window.makeDateRangePicker = function ($el) {
    var _$el$attr, _$el$attr2;
    var drops = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'down';
    var format1 = (_$el$attr = $el.attr('data-format')) !== null && _$el$attr !== void 0 ? _$el$attr : 'YYYY-MM-DD';
    var timepicker1 = !!$el.attr('data-timepicker');
    var elParent = (_$el$attr2 = $el.attr('data-el-parent')) !== null && _$el$attr2 !== void 0 ? _$el$attr2 : 'body';
    $el.daterangepicker({
      locale: {
        format: format1,
  ...
  window.makeDateTimepicker = function ($el) {
    var _$el$attr3, _$el$attr4;
    var drops = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'down';
    var format2 = (_$el$attr3 = $el.attr('data-format')) !== null && _$el$attr3 !== void 0 ? _$el$attr3 : 'YYYY-MM-DD HH:mm';
    var showDropdowns = !!$el.attr('data-show-drops');
    var elParent = (_$el$attr4 = $el.attr('data-el-parent')) !== null && _$el$attr4 !== void 0 ? _$el$attr4 : 'body';
    $el.daterangepicker({
      locale: {
        format: format2,
        cancelLabel: clearLang
  ...
  window.makeSingleDatePicker = function ($el) {
    var _$el$attr5, _$el$attr6;
    var drops = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'down';
    var format3 = (_$el$attr5 = $el.attr('data-format')) !== null && _$el$attr5 !== void 0 ? _$el$attr5 : 'YYYY-MM-DD';
    var showDropdowns = !!$el.attr('data-show-drops');
    var elParent = (_$el$attr6 = $el.attr('data-el-parent')) !== null && _$el$attr6 !== void 0 ? _$el$attr6 : 'body';
    $el.daterangepicker({
      locale: {
        format: format3,
        cancelLabel: clearLang
  ...
  window.resetDatePickers = function () {
    var drops = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'down';
    /*
    * drops => down | up
    * */
  ...
  * */
  $(document).ready(function () {
    var $defaultInitDatePickers = $('.js-default-init-date-picker');
    if ($defaultInitDatePickers.length) {
      var _$defaultInitDatePick;
      var drops = (_$defaultInitDatePick = $defaultInitDatePickers.attr("data-drops")) !== null && _$defaultInitDatePick !== void 0 ? _$defaultInitDatePick : 'down';
  ...
  *
  * */
  window.handleSendRequestItemForm = function ($form, $this) {
    var path = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
    var formActionAttr = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "data-action";
    var scrollToError = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : true;
    var action = path ? path : $form.attr(formActionAttr);
    $this.addClass('loadingbar').prop('disabled', true);
    $form.find('input').removeClass('is-invalid');
    $form.find('textarea').removeClass('is-invalid');
    $form.find('.invalid-feedback').text('');
    var $customAlertEl = $form.find(".js-form-custom-alert");
    ...
    var uploadFiles = $form.find('.js-ajax-upload-file-input');
    if (uploadFiles.length) {
      var _iterator4 = _createForOfIteratorHelper(uploadFiles),
        _step4;
      try {
        for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
          var uploadFileEl = _step4.value;
          var uploadFile = $(uploadFileEl);
          if (uploadFile && uploadFile.prop('files') && uploadFile.prop('files')[0]) {
            var name = uploadFile.attr('data-upload-name') ? uploadFile.attr('data-upload-name') : 'upload_file';
    ...
    var images = $form.find('.js-create-property-images');
    ...
    $.ajax({
      ...
      success: function success(result) {
        if (result && result.code === 200) {
          var _result$title3, _result$msg3;
          //window.location.reload();
          var dontReloadPage = typeof result.dont_reload !== "undefined" && result.dont_reload;
          var title = (_result$title3 = result.title) !== null && _result$title3 !== void 0 ? _result$title3 : requestSuccessLang;
          var msg = (_result$msg3 = result.msg) !== null && _result$msg3 !== void 0 ? _result$msg3 : saveSuccessLang;
          showToast('success', title, msg);
          var timeout = result.redirect_timeout ? Number(result.redirect_timeout) : 500;
          if (dontReloadPage) {
      ...
      error: function error(err) {
        ...
        if (errors && errors.errors) {
          Object.keys(errors.errors).forEach(function (key) {
            ...
            var ky = key.replaceAll('.', '-');
            var element = $form.find('.js-ajax-' + ky);
            element.addClass('is-invalid');
            element.closest('.form-group').find('.invalid-feedback').text(error[0]);
          });
          if (scrollToError) {
            var $elScroll = $form.find('.is-invalid');
            if ($elScroll.length) {
              var $swlModalBody = $('.custom-swl-modal-body');
  ...
  // Basic Modal
  // ======
  window.handleBasicModal = function (path, title, callback) {
    var subtitle = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
    var modalSize = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : '34rem';
  ...
  * */
  window.handleFireSwalModal = function (html) {
  ...
  $('body').on('click', '.js-custom-file-clear', function (e) {
    ...
    var text = (_$this$attr = $this.attr('data-text')) !== null && _$this$attr !== void 0 ? _$this$attr : '';
  ...
  $('body').on('click', '.js-back-to-top-btn', function (e) {
    ...
    e.preventDefault();
    var $this = $(this);
    var speed = (_$this$attr2 = $this.attr('data-speed')) !== null && _$this$attr2 !== void 0 ? _$this$attr2 : 5000;
    $('html, body').animate({
      scrollTop: 0
    }, Number(speed));
  });
...
__webpack_require__(/*! ./../design_1/app_includes/icon_picker */ "./resources/js/design_1/app_includes/icon_picker.js");
__webpack_require__(/*! ./../design_1/app_includes/main */ "./resources/js/design_1/app_includes/main.js");
